...
export class ProjectListComponent implements OnInit {
  ...
  openNewProjectDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      console.log(result)
      this.projects = [...this.projects,{id:3,name:'一个新项目',desc:'这是一个新项目',coverImg:'assets/img/covers/1.jpg'},{id:4,name:'ww一个新项目',desc:'这是一个新项目',coverImg:'assets/img/covers/1.jpg'}]
    })
  }
